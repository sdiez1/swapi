...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference('Planet.count') do
      post planets_url, params: { planet: { climate: @planet.climate, diameter: @planet.diameter, films: @planet.films, gravity: @planet.gravity, name: @planet.name, orbital_period: @planet.orbital_period, population: @planet.population, residents: @planet.residents, rotation_period: @planet.rotation_period, surface_water: @planet.surface_water, terrain: @planet.terrain, url: @planet.url } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { climate: @planet.climate, diameter: @planet.diameter, films: @planet.films, gravity: @planet.gravity, name: @planet.name, orbital_period: @planet.orbital_period, population: @planet.population, residents: @planet.residents, rotation_period: @planet.rotation_period, surface_water: @planet.surface_water, terrain: @planet.terrain, url: @planet.url } }
